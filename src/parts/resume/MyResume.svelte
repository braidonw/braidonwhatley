<script>
  ...
  let resumeElement = document.getElementById("html2pdf-wrapper");
  const opt = {
    margin: 1,
    filename: "myfile.pdf",
  ...
  function genPDF() {
    console.log("starting to gen pdf");
    let doc = html2pdf().set(opt).from(resumeElement);
    console.log(doc);
    doc.save();
  }
</script>

<div id="html2pdf-wrapper">
  <div class="px-4 py-5 sm:p-6 bg-white rounded-lg shadow-lg mt-8">
    <div class="border-b border-gray-200 py-1 mt-6">
    ...
    <div class="mt-6">
      <span class="text-gray-700 text-lg italic">
      ...
      <span class="text-gray-700 text-lg italic">
        He's a generalist with experience in project management, data analysis,
      ...
      <div class="space-y-10 mt-3">
        ...
        <Job
          ...
          <JobLine>
            ...
            GraphQL that connects aged care providers with people in the
            community in need of their services.
          </JobLine>
        ...
        <Job
          ...
          <JobLine>
            I engaged and managed a team from a product design agency to design
            a new mobile application to support our healthcare labour-hire
            business. We built an interactive prototype, which we validated
            along with our initial problem- and solution-hypotheses by
            conducting 16 1-on-1 user interviews across several nursing agencies
            in Australia.
          </JobLine>
          <JobLine>
        ...
        <Job
          ...
          toDate={'Mar 2020'}>
          <JobLine>
            Successfully managed several key projects simultaneously as part of
            a Business Transformation Program initiated after a Private Equity
            acquisition.
          </JobLine>
          <JobLine>
            I delivered a $900k reduction in annualised labour costs by
            delivering a $1m+ business automation solution. My 12-person project
            team, from three globally disperse organisations, used an Agile
            methodology to deliver a system that was integrated with SAP and
            used Optical Character Recognition to process 300k vendor invoices
            and 300k customer remittances per annum.
          </JobLine>
          <JobLine>
            I managed a 5-person project team to deliver an SAP FICO enhancement
            that allowed a surcharge to be applied to post-dispatch card
            payments. The business realised a reduction in card payment
            processing costs of $400k per annum from this enhancement.
          </JobLine>
          <JobLine>
          ...
          <JobLine>
            ...
            users that were not ordering at expected levels and identified $40M
            in missed revenue. I presented my analysis to a VP at our Private
            Equity owners, and subsequently kicked-off an initiative with our
            Sales teams to capture the revenue.
          </JobLine>
          <JobLine>
            As part of designing a new commissions structure for the entire
            Sales organisation (350+ sales reps), I built a Python model that
            used a Monte-Carlo method to analyse the expected cost and risk of
            various options. I used the model to provide real-time guidance to
            the Senior Management and Executive team to dramatically increase
            the speed of the commission scheme design.
          </JobLine>
          <JobLine>
            I delivered a reporting and analytics solution that provided the
            Sales organisation, from Executive team to Sales person, with an
            ...
            Salesforce.com and both our SQL and SAP HANA databases, as well as
            the delivery of 20+ Tableau dashboards.
          </JobLine>
          <JobLine>
            Managed the design, development, and implementation of other
            projects spanning Salesforce.com, Business Intelligence (SSRS,
            Crystal reports and Tableau) and SAP.
          </JobLine>
        </Job>
        ...
        <Job
          ...
          <JobLine>
            ...
            processing system for 400 Sales Associates. Worked with the
            technical team throughout the development, testing, change
            management and successful implementation of the solution.
          </JobLine>
          <JobLine>
        ...
        <Job
          ...
          <JobLine>
            Worked with Sales Leaders to develop and implement new sales
            targeting methodologies, commission schemes, territory management
            plans, and reporting & analysis tools to support the organisational
            restructures of the Facilities Solutions and Furniture business
            divisions.
          </JobLine>
        </Job>
        ...
        <Job
          ...
          <JobLine>
            ...
            Toyota dealerships in Sydney and Adelaide to assess current and
            future needs of a tailored CRM solution, and presented key findings
            to Project stakeholders and Executive team members. Recommendations
            were then successfully validated with a workshop involving over 50
            Toyota dealers and TFS staff, with findings and recommendations
            provided back to project stakeholders.
          </JobLine>
          <JobLine>
            Facilitated design-thinking workshops with senior managers, project
            stakeholders, and executive team members of David Jones to construct
            a framework for their desired strategy towards customer experience.
            Worked to create new set of customer service standards reflecting
            this strategy, and successfully validated them in a live retail
            environment.
          </JobLine>
          <JobLine>
            ...
            remote payment solutions and merchant banking services, and
            developed several key insights and strategic recommendations that
            were then delivered back to key project stakeholders at CBA.
          </JobLine>
        </Job>
      </div>
    </div>
