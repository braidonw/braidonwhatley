        ...
        <div class="pt-5 pb-6 px-5 space-y-6">
          ...
          <div>
            <nav class="grid grid-cols-1 gap-7">
              <a
                href="#"
                class="-m-3 p-3 flex items-center space-x-4 rounded-lg
                hover:bg-gray-50 transition ease-in-out duration-150">
                <div
                  class="flex-shrink-0 flex items-center justify-center h-10
                  w-10 rounded-md bg-indigo-500 text-white">
                  <svg
                    class="h-6 w-6"
                    fill="none"
                    viewBox="0 0 24 24"
                    ...
                    <path
                      ...
                      002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2
                ...
                <div
                  ...
                  <svg
                    ...
                    <path
                      ...
                      2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2
                      0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012
        ...
        <div class="py-6 px-5 space-y-6">
          <div class="grid grid-cols-2 gap-4">
            <a
              ...
              hover:text-gray-700 transition ease-in-out duration-150">
              Pricing
            </a>
            <a
              href="#"
